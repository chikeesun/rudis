 ...
 * @LastEditTime: 2024-04-22 22:53:47
...
int main(int argc, char **argv) {
  ...
  while(true)
  {
    ...
    int l=0,r=0;
    idx = received_data.find_first_of("\"");
    if(idx != received_data.npos){
      idx++;
    }
    else{
    ...
    while(received_data[idx]!='\"')
    { 
      int l=idx,r=received_data.find("\n");
      std::string command = received_data.substr(l, r);
